...
public class LapPeserta extends javax.swing.JFrame {
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportActionPerformed
        // TODO add your handling code here:
        try{
            ExportToExcel ex = new ExportToExcel(tblPeserta, new File("LapPeserta.xls"));
    ...
    private void baca_data(){
        try {
            ...
            RsPst.beforeFirst();
            while(RsPst.next()){
                dataTable[x][0] = RsPst.getString("no_peserta");
                dataTable[x][1] = RsPst.getString("nm_peserta");
                dataTable[x][2] = RsPst.getString("email");
                dataTable[x][3] = RsPst.getString("alamat");
                dataTable[x][4] = RsPst.getString("kota");
                dataTable[x][5] = RsPst.getString("telp");
